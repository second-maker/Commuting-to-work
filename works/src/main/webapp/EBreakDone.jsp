...
<body class="text-center bg-light">
  ...
  <div class="border rounded bg-white menu">
      <h1 class="text-success">休憩終了確認画面</h1>

      <p id="item"></p>

      <p class="h2 mt-5 text-success">
      	<p class="sample text-success">${work.date} / ${work.endBreakTime}に</p>　<p class="sample text-success">【${user.name}】さんの出勤を登録しました。</p>
      </p>
  </div>
