...
<% 
	...
	dto.WorkDTO work = (dto.WorkDTO)request.getAttribute("work");
%>
...
<body class="text-center bg-light">
  ...
  <div class="border rounded bg-white menu">
      <h1 class="text-danger">休憩確認画面</h1>

      <p id="item"></p>

      <p class="h2 mt-5 text-danger">
      	<p class="sample text-danger">${work.date} / ${work.breakTime}に</p>　<p class="sample text-danger">【${user.name}】さんの休憩を登録しました。</p>
      </p>
  </div>
