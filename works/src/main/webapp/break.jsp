...
<head>
	...
	<title>従業員休憩登録画面</title>
</head>
<body class="text-center bg-light">

    <img src="<%=request.getContextPath() %>/img/logo.png" alt="ロゴマーク">

    <h1 class="text-danger">休憩登録画面</h1>
    <p id="item"></p>

    <form action="./BreakWork" method="post" class="border rounded bg-white login-form">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-danger rounded-pill">休憩する</button>
