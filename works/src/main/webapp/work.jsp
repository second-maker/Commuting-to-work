...
<body class="text-center bg-light">
    ...
    <h1 class="text-primary">社員出勤画面</h1>
    <p id="item"></p>

    <form action="./GoWork" method="post" class="border rounded bg-white login-form">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary rounded-pill">出勤する</button>
