...
<body class="text-center bg-light">
    ...
    <h1 class="text-secondary">従業員退勤画面</h1>
    <p id="item"></p>

    <form action="./EndWork" method="post" class="border rounded bg-white login-form">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-secondary rounded-pill">退勤する</button>
