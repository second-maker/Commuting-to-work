...
<body class="text-center bg-light">
    ...
    <div class="form">
        <form action="./RegisterServlet" method="post" class="border rounded bg-white login-form menu">
            ...
            <div class="mb-3 d-flex box">
                <p class="input-title">パスワード再入力</p>
                <input type="password" name="password2" value="" class="form-control">
            </div>
            
            <div class="mb-3 d-flex box">
                <p class="input-title">氏名</p>
                <input type="text" name="name" value="" class="form-control" placeholder="例)田村　ゆかり">
            </div>
